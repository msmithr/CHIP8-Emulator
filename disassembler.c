...
int disassemble(unsigned char *buff, unsigned short pc) {
    ...
    switch (nibble) {
        ...
        case 0x5: printf("SE V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
        case 0x6: printf("LD V%01x, #%02x", opcode[0]&0xf, opcode[1]); break;
        case 0x7: printf("ADD V%01x, #%02x", opcode[0]&0xf, opcode[1]); break;
        case 0x8: 
            switch (opcode[1]&0x3) {
                case 0x0: printf("LD V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
                case 0x1: printf("OR V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
                case 0x2: printf("AND V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
                case 0x3: printf("XOR V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
                case 0x4: printf("ADD V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
                case 0x5: printf("SUB V%01x, V%01x", opcode[0]&0xf, opcode[1]>>4); break;
        ...
        case 0xA: printf("LD I, $%01x%02x", opcode[0]&0xf, opcode[1]); break;
        case 0xB: printf("JP V0, $%01x%02x", opcode[0]&0xf, opcode[1]); break;
        case 0xC: printf("RND V%01x, #%02x", opcode[0]&0xf, opcode[1]); break;
        case 0xD: printf("DRW V%01x, V%01x, #%01x", opcode[0]&0xf, opcode[1]>>4, opcode[1]&0xf); break;
        case 0xE: 
            switch (opcode[1]) {
        ...
        case 0xF: 
            switch (opcode[1]) {
                case 0x07: printf("LD V%01x, DT", opcode[0]&0xf); break;
                case 0x0a: printf("LD V%01x, K", opcode[0]&0xf); break;
                case 0x15: printf("LD DT, V%01x", opcode[0]&0xf); break;
                case 0x18: printf("LD ST, V%01x", opcode[0]&0xf); break;
                case 0x1e: printf("ADD I, V%01x", opcode[0]&0xf); break;
                case 0x29: printf("LD F, V%01x", opcode[0]&0xf); break;
